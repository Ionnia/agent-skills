...
const BLOCK_TYPES = ["prereq", "text", "attention", "example", "image", "formula", "selfcheck", "resources", "table"];
const REMOVED_TYPES = [];
const PREREQ_FIRST = true;
...
function validateBlock(blk, topicId) {
  ...
  if (REMOVED_TYPES.includes(blk.type))
    throw new Error(topicId + ": block type " + JSON.stringify(blk.type) + " is not supported in this skill");
